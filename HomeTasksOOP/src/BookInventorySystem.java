...
class MyBookNotFoundException extends Exception {
...
public class BookInventorySystem {
    ...
    private static class InventoryIterator implements Iterator<Book> {
        private Iterator<Book> iterator;

        public InventoryIterator() {
            iterator = inventory.values().iterator();
        }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                handleChoice(choice);
            } catch (MyBookNotFoundException e) {
    ...
    private static void handleChoice(int choice) throws MyBookNotFoundException {
        switch (choice) {
            case 1:
                addBook();
                break;
    ...
    private static void removeBook() throws MyBookNotFoundException {
        System.out.print("Enter book title to remove: ");
        String title = scanner.nextLine();
        Book book = inventory.get(title);
        if (book == null) {
            throw new MyBookNotFoundException("Book with title '" + title + "' not found.");
        } else {
    ...
    private static void updateBook() throws MyBookNotFoundException {
